...
class TestCollectionManifestParameters(unittest.TestCase):

    def setUp(self):
        self.headers = REQUEST_HEADERS_MANIFEST.copy()
    ...
    def log_response(self, test_name, test_num, url, headers, response, auth=None):
    ...
    def test_get_collection_manifest_limit_1(self):
        test_name = 'test_get_collection_manifest_limit_1'
        self.test_counter += 1
        ...
        self.log_response(test_name, self.test_counter, response.url, self.headers, response, auth="read_write_user")
    ...
    def test_get_collection_manifest_limit_100(self):
        test_name = 'test_get_collection_manifest_limit_100'
        self.test_counter += 1
        api_root = API_ROOT[0]  # Using the first API root from the list
        collection_id = "mitre_attack_enterprise"
        url = URL_COLLECTION_MANIFEST.replace("{API_ROOT}", api_root).replace("{COLLECTION_ID}", collection_id)
    ...
    def test_get_collection_manifest_type(self):
        test_name = 'test_get_collection_manifest_type'
        self.test_counter += 1
        api_root = API_ROOT[0]  # Using the first API root from the list
        collection_id = "mitre_attack_enterprise"
        url = URL_COLLECTION_MANIFEST.replace("{API_ROOT}", api_root).replace("{COLLECTION_ID}", collection_id)
        params = {"match[type]": "marking-definition,attack-pattern"}
        ...
        response_json = response.json()
        self.assertIn('objects', response_json, "Expected 'objects' key in response")
        self.assertEqual(len(response_json['objects']), 50, f"Expected 50 objects, got {len(response_json['objects'])}")
        self.assertTrue(response_json.get('more'), "Expected 'more' to be true")
        ...
        for obj in response_json['objects']:
            ...
            self.assertTrue(obj['id'].startswith("marking-definition--") or obj['id'].startswith("attack-pattern--"), f"Unexpected id format: {obj['id']}")

    def test_get_collection_manifest_match_id_single(self):
        test_name = 'test_get_collection_manifest_match_id_single'
        self.test_counter += 1
        api_root = API_ROOT[0]  # Using the first API root from the list
        collection_id = "mitre_attack_enterprise"
    ...
    def test_get_collection_manifest_match_id_multiple(self):
        test_name = 'test_get_collection_manifest_match_id_multiple'
        self.test_counter += 1
        api_root = API_ROOT[0]  # Using the first API root from the list
        collection_id = "mitre_attack_enterprise"
    ...
    def test_get_collection_manifest_match_version_first(self):
        test_name = 'test_get_collection_manifest_match_version_first'
        self.test_counter += 1
        api_root = API_ROOT[0]
        collection_id = "mitre_attack_enterprise"
        object_id = "attack-pattern--67720091-eee3-4d2d-ae16-8264567f6f5b"
        url = URL_COLLECTION_MANIFEST.replace("{API_ROOT}", api_root).replace("{COLLECTION_ID}", collection_id)
        params = {"match[id]": object_id, "match[version]": "first"}
    ...
    def test_get_collection_manifest_match_version_last(self):
        test_name = 'test_get_collection_manifest_match_version_last'
        self.test_counter += 1
        api_root = API_ROOT[0]
        collection_id = "mitre_attack_enterprise"
        object_id = "attack-pattern--67720091-eee3-4d2d-ae16-8264567f6f5b"
        url = URL_COLLECTION_MANIFEST.replace("{API_ROOT}", api_root).replace("{COLLECTION_ID}", collection_id)
        params = {"match[id]": object_id, "match[version]": "last"}
    ...
    def test_get_collection_manifest_match_version_first_last(self):
        test_name = 'test_get_collection_manifest_match_version_first_last'
        self.test_counter += 1
        api_root = API_ROOT[0]
        collection_id = "mitre_attack_enterprise"
        object_id = "attack-pattern--67720091-eee3-4d2d-ae16-8264567f6f5b"
        url = URL_COLLECTION_MANIFEST.replace("{API_ROOT}", api_root).replace("{COLLECTION_ID}", collection_id)
        params = {"match[id]": object_id, "match[version]": "first,last"}
    ...
    def test_get_collection_manifest_match_version_specific(self):
        test_name = 'test_get_collection_manifest_match_version_specific'
        self.test_counter += 1
        api_root = API_ROOT[0]
        collection_id = "mitre_attack_enterprise"
        object_id = "attack-pattern--67720091-eee3-4d2d-ae16-8264567f6f5b"
        url = URL_COLLECTION_MANIFEST.replace("{API_ROOT}", api_root).replace("{COLLECTION_ID}", collection_id)
        params = {"match[id]": object_id, "match[version]": "2024-02-02T19:04:35.389Z"}
    ...
    def test_get_collection_manifest_match_version_all(self):
        test_name = 'test_get_collection_manifest_match_version_all'
        self.test_counter += 1
        api_root = API_ROOT[0]
        collection_id = "mitre_attack_enterprise"
        object_id = "attack-pattern--67720091-eee3-4d2d-ae16-8264567f6f5b"
        url = URL_COLLECTION_MANIFEST.replace("{API_ROOT}", api_root).replace("{COLLECTION_ID}", collection_id)
        params = {"match[id]": object_id, "match[version]": "all"}
